    ...
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            ...
            <div class="d-none d-md-flex align-items-center mx-auto">
                <a href="<?php echo e(route('contact')); ?>" class="btn btn-submit-pink blink text-white px-3 px-md-4 py-2 rounded fw-semibold small">Contact us</a>
            </div>

            <div class="d-none d-md-flex align-items-center mx-auto">
                <a href="<?php echo e(route('order')); ?>" class="btn btn-submit-pink blink text-white px-3 px-md-4 py-2 rounded fw-semibold small">
            ...
            <ul class="list-unstyled d-flex flex-column align-items-center gap-3 mb-0">
                ...
                <li class="dropdown w-100 text-center">
                    ...
                    <ul id="flavourSub" class="collapse list-unstyled mt-2" data-bs-parent="#mobile-menu">
                        <li><a class="dropdown-item py-2" href="<?php echo e(route('flavours', ['category' => 'kulfi'])); ?>">Kulfi</a></li>
                        <li><a class="dropdown-item py-1" href="<?php echo e(route('flavours', ['category' => 'ice-creams'])); ?>">Ice Creams</a></li>
                        <li><a class="dropdown-item py-1" href="<?php echo e(route('flavours', ['category' => 'ice-candy'])); ?>">Ice Candy</a></li>
                        <li><a class="dropdown-item py-1" href="<?php echo e(route('flavours', ['category' => 'bulk-packer'])); ?>">Bulk packer</a></li>
                        <li><a class="dropdown-item py-1" href="<?php echo e(route('flavours', ['category' => 'new-launches'])); ?>">New Launches</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo e(route('store.locator')); ?>" class="nav-link-custom">Store locator</a></li>
                <li><a href="<?php echo e(route('media')); ?>" class="nav-link-custom fs-5">Media</a></li>
                <li class="dropdown w-100 text-center">
                    ...
                    <ul id="businessSub" class="collapse list-unstyled mt-2" data-bs-parent="#mobile-menu">
                        <li><a class="dropdown-item py-2" href="<?php echo e(route('distributor')); ?>">Distributor</a></li>
                        <li><a class="dropdown-item py-2" href="<?php echo e(route('franchise')); ?>">Franchise</a></li>
                    </ul>
                </li>
                <li><a href="<?php echo e(route('contact')); ?>" class="nav-link-custom fs-5">Contact Us</a></li>
                <li><a href="<?php echo e(route('order')); ?>" class="nav-link-custom fs-5"><i class="bi bi-cart-fill me-2"></i>Order Now</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<div class="d-none d-md-flex container-fluid justify-content-center align-items-center header-nav-wrapper header-line sticky-top">
    <nav class="d-flex p-2 align-items-center flex-wrap gap-1 gap-md-3 gap-lg-4 gap-xl-5 px-3 px-md-2">
        ...
        <a href="<?php echo e(route('store.locator')); ?>" class="nav-link-custom">Store locator</a>
        <a href="<?php echo e(route('media')); ?>" class="nav-link-custom">Media</a>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="businessDropdown">
                <li><a class="dropdown-item" href="<?php echo e(route('distributor')); ?>">Distributor</a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('franchise')); ?>">Franchise</a></li>
            </ul>
        </div>

        <a href="<?php echo e(route('contact')); ?>" class="nav-link-custom">Contact us</a>
        <a href="<?php echo e(route('order')); ?>" class="nav-link-custom"><i class="bi bi-cart-fill me-1"></i>Order now</a>
    </nav>
</div>
...
<?php /**PATH C:\xampp\htdocs\yashpal\picnic-laravel\resources\views/partials/header.blade.php ENDPATH**/ ?>