...
<section class="py-5 px-3 px-md-5" style="background: url('<?php echo e(asset('assets/images/bg/color2.png')); ?>') no-repeat center center; background-size: cover;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\yashpal\picnic-laravel\resources\views/pages/contact.blade.php ENDPATH**/ ?>