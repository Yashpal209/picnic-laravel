<?php $__env->startSection('title', 'Distributor - Picnic Ice Creams'); ?>
    ...
    <section class="about-franchise py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?php echo e(asset('public/assets/images/ice-creem/7.png')); ?>" alt="Distributor" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 g-md-5 align-items-center">
                <div class="col-md-6">
                    <form class="bg-white p-4 rounded-3 shadow-lg" method="POST"
                        action="<?php echo e(route('leads.distributor')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                ...
                <div class="col-md-6">
                    <img src="<?php echo e(asset('public/assets/images/500x350.png')); ?>" alt="Contact Distributor"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\yashpal\picnic-laravel\resources\views/pages/distributor.blade.php ENDPATH**/ ?>