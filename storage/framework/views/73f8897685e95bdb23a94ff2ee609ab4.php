    ...
    <section class="about-franchise py-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="<?php echo e(asset('assets/images/ice-creem/7.png')); ?>" alt="Distributor" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="custom-bg py-5 distributor-sec" id="contact-business">
        <div class="container text-center px-3 px-md-5">
            ...
            <div class="row g-4 g-md-5 align-items-center">
                ...
                <div class="col-md-6">
                    <img src="<?php echo e(asset('assets/images/500x350.png')); ?>" alt="Contact Distributor"
