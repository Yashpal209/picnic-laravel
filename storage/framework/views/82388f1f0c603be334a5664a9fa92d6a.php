        ...
        <div class="timeline">
            ...
            <div class="timeline-item left">
                <div class="timeline-content bg-white rounded-4 shadow-lg p-4 timeline-content-custom">
                    <img src="<?php echo e(asset('public/assets/images/ice-creem/6.png')); ?>" alt="Strawberry Bliss" class="mx-auto mb-3 timeline-item-img">
            ...
            <div class="timeline-item right">
                <div class="timeline-content bg-white rounded-4 shadow-lg p-4 timeline-content-custom">
                    <img src="<?php echo e(asset('public/assets/images/ice-creem/5.png')); ?>" alt="Mint Magic" class="mx-auto mb-3 timeline-item-img">
            ...
            <div class="timeline-item left">
                <div class="timeline-content bg-white rounded-4 shadow-lg p-4 timeline-content-custom">
                    <img src="<?php echo e(asset('public/assets/images/ice-creem/3.png')); ?>" alt="Blueberry Dream" class="mx-auto mb-3 timeline-item-img">
            ...
            <div class="timeline-item right">
                <div class="timeline-content bg-white rounded-4 shadow-lg p-4 timeline-content-custom">
                    <img src="<?php echo e(asset('public/assets/images/ice-creem/6.png')); ?>" alt="Mint Magic" class="mx-auto mb-3 timeline-item-img">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\yashpal\picnic-laravel\resources\views/pages/about.blade.php ENDPATH**/ ?>