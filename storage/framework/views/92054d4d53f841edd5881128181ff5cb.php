        ...
        <table class="table table-sm table-striped table-modern mb-0">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.testimonials.edit', $test)); ?>" class="btn btn-sm btn-outline-primary">Edit</a>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="5" class="text-center text-muted py-4">No testimonials. <a href="<?php echo e(route('admin.testimonials.create')); ?>" class="btn btn-sm btn-outline-danger">Create one</a></td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </div>
