    ...
    <div class="table-responsive">
        <table class="table table-sm table-striped table-modern mb-0">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($cat->thumbnail): ?>
                            <img src="<?php echo e($cat->thumbnail); ?>" alt="" class="img-thumbnail" style="max-height:50px;">
                        <?php endif; ?>
                    </td>
                    ...
                    <td>
                        <a href="<?php echo e(route('admin.categories.edit', $cat)); ?>" class="btn btn-xs btn-outline-primary">Edit</a>
                        <form action="<?php echo e(route('admin.categories.destroy', $cat)); ?>" method="POST" style="display: inline;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr><td colspan="5" class="text-center text-muted py-4">No categories. <a href="<?php echo e(route('admin.categories.create')); ?>">Create one</a></td></tr>
            <?php endif; ?>
            </tbody>
        </table>
    </div>
