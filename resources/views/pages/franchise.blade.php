...
<section class="about-franchise py-4">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h2><span>Franchisee</span> Happiness<br>Together</h2>
            ...
            <div class="col-md-6">
                <img src="{{ asset('assets/images/ice-creem/5.png') }}" alt="Franchise" class="img-fluid">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4 g-md-5 align-items-center">
            <div class="col-md-6">
                <form class="bg-white p-4 rounded-3 shadow-lg" method="POST" action="{{ route('leads.franchise') }}">
                    ...
                    <div class="mb-3">
                        <label for="amount" class="form-label text-start d-block fw-semibold text-dark">Interested Amount</label>
            ...
            <div class="col-md-6">
                <img src="{{ asset('assets/images/500x350.png') }}" alt="Contact Franchise" class="w-100 h-auto rounded-3">
            </div>
        </div>
    </div>
</section>
