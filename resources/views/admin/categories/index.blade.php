        ...
        <table class="table table-sm table-striped table-modern mb-0">
            ...
            @forelse($categories as $cat)
                <tr>
                    ...
                    <td>
                        @if($cat->thumbnail)
                            <img src="{{ $cat->thumbnail }}" alt="" class="img-thumbnail" style="max-height:50px;">
                        @endif
                    </td>
                    <td>{{ $cat->name }}</td>
                    ...
                    <td>
                        <a href="{{ route('admin.categories.edit', $cat) }}" class="btn btn-xs btn-outline-primary">Edit</a>
            ...
            @empty
                <tr><td colspan="5" class="text-center text-muted py-4">No categories. <a href="{{ route('admin.categories.create') }}">Create one</a></td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
